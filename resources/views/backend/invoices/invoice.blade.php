            ...
            <table style="width: 100%; margin-top: 0rem;">
                ...
                <tr>
                    ...
                    <td class="text-right small" style="vertical-align: top; padding: 5px; white-space: nowrap;">
                        {{ translate('Order ID') }}: <span class="strong">{{ $order->code }}</span><br>
                        {{ translate('Order Date') }}: <span class="strong">{{ date('d-m-Y', $order->date) }}</span>
                    </td>
                </tr>
            </table>
        </div>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td class="gry-color small">
                        Delivery Type :{{ $order[1]->orderDetails()->first()->shipping_type ?? 'Home Delivery' }}
                    </td>
                    @else
                    <td class="gry-color small">
                        Delivery Type :{{ $order->orderDetails()->first()->shipping_type ?? 'Home Delivery' }}
                    </td>
                    @endif
                </tr>
            </table>
                        ...
                        <table class="text-left sm-padding small strong">
                            <tr>
                                <td class="payment_type">
                                    ...
                                    @elseif ($order->payment_type == 'jazzcash')
