...
<form method="GET" action="{{ route('admin_business_directory.index') }}">
    <div class="row mb-3">
                                    ...
                                    @foreach ($business_directory as $item)
                                        <tr>
                                            ...
                                            <td>
                                                    ...
                                                    <div class="">
                                                        <span class="text-truncate-2">{{ $item->user->shop->name }}</span>
                                                    </div>
                                            ...
                                            <td>@if(!empty($item->business_type))<span class="badge badge-primary w-auto text-capitalize">{{ $item->business_type }}@endif</td>
