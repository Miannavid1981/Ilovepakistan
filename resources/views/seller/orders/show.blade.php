    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="col text-md-left text-center">
                ...
                @php $manual_payment_data = json_decode($order->manual_payment_data); @endphp
                {{ translate('Name') }}: {{ $manual_payment_data->name ?? 'N/A' }},
                {{ translate('Amount') }}: {{ single_price($manual_payment_data->amount ?? 0) }},
                {{ translate('TRX ID') }}: {{ $manual_payment_data->trx_id ?? 'N/A' }}
                <br>
                <a href="{{ url('public/' . ($manual_payment_data->photo ?? 'placeholder.png')) }}" target="_blank">
                    <img src="{{ url('public/' . ($manual_payment_data->photo ?? 'placeholder.png')) }}" alt="" height="100">
                </a>
