...
.card {
    ...
    <div class="row mt-4">
                    ...
                    <div class="row align-items-center">
                        <div class="col">
                            <p class="small text-muted mb-0">
                                ...
                                <span class="fs-14 text-dark">{{ translate('Available Balance') }}</span>
                            </p>
                        ...
                        <div class="col-auto text-right">
                            <svg xmlns="http://www.w3.org/2000/svg" width="100px" viewBox="0 0 24 24" fill="none">
        ...
        <div class="col-sm-6 col-md-4 col-xxl-4">
            <div class="card shadow-none mb-4 bg-secondary py-4">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            <p class="small text-muted mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-14 text-dark">{{ translate('Pending Balance') }}</span>
                            </p>
                            <h3 class="mb-0 text-dark fs-30">
                                @php
        ...
        @if( $seller_type == "store_partner" )
            <div class="col-sm-6 col-md-4 col-xxl-4">
                <div class="card shadow-none mb-4 bg-light py-4">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col">
                                <p class="small text-muted mb-0">
                                    <span class="fe fe-arrow-down fe-12"></span>
                                    <span class="fs-14 text-dark">{{ translate('Upcoming Profit') }}</span>
                                </p>
                                <h3 class="mb-0 text-dark fs-30">
                                    @php
                                        $total_pending_profit = 0;
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col">
                                <p class="small text-muted mb-0">
                                    <span class="fe fe-arrow-down fe-12"></span>
                                    <span class="fs-14 text-dark">{{ translate('Upcoming Sale') }}</span>
                                </p>
                                <h3 class="mb-0 text-dark fs-30">
                                    @php
  ...
  @if($seller_type != 'brand_partner')
    <div class="row">
        ...
        <div class="col-sm-6 col-md-3 col-xxl-3 mt-3">
            <div class="card shadow-none bg-soft-success mb-0">
                <div class="card-body">
                    <div class="card-title text-primary fs-16 fw-600">
                        {{ translate('Available Balance') }}
                    </div>
                    <p>{{ translate('Amount available for Withdraw') }}</p>
                    ...
                    <a href="" class="btn btn-primary "> 
                            ...
                            <path id="Path_110"
                                ...
                                fill="#fff" />
                            <path id="Path_111" d="M28.5,21h-9a4.5,4.5,0,0,0,9,0" fill="#fff" />
                        </svg>
                        Withdraw</a>
                    </p>
                    @endif
        ...
        <div class="col-sm-6 col-md-3 col-xxl-3 mt-3">
            <div class="card shadow-none bg-soft-warning mb-0">
                <div class="card-body">
                    <div class="card-title text-primary fs-16 fw-600">
                        {{ translate('Upcoming Profits') }}
                    </div>
                    <p>{{ translate('Total Commission earned from Marketplace') }}</p>
                    <h3 class="text-primary fw-600 fs-30">
                        {{ single_price(0) }}
                    </h3>
        ...
        <div class="col-sm-6 col-md-3 col-xxl-3 mt-3">
            <div class="card shadow-none bg-soft-info mb-0">
                <div class="card-body">
                    <div class="card-title text-primary fs-16 fw-600">
                        {{ translate('Commission Earned') }}
                    </div>
                    <p>{{ translate('Commission earned from Marketplace') }}</p>
                    <h3 class="text-primary fw-600 fs-30">
                        {{ single_price(0) }}
                    </h3>
        ...
        <div class="col-sm-6 col-md-3 col-xxl-3 mt-3">
            <div class="card shadow-none bg-soft-primary mb-0">
                <div class="card-body">
                    ...
                    <p>{{ translate('The amount withdrawn') }}</p>
                    <h3 class="text-primary fw-600 fs-30">
                        {{ single_price(0) }}
                    </h3>
            ...
            <div class="card shadow-none mb-4 bg-soft-primary py-4">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            <div class="card-title text-primary fs-16 fw-600">
                                {{ translate('Marketplace Imports') }}
                            </div>
                            <h3 class="mb-0 text-dark fs-30">
                                {{ \App\Models\ProductSellerMap::where('seller_id', $authUser->id)->where('imported', 1)->count() }}
                            </h3>
            ...
            <div class="card shadow-none mb-4 bg-soft-primary py-4">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            <div class="card-title text-primary fs-16 fw-600">
                                {{ translate('Pending Market Orders') }}
                            </div>
                            <h3 class="mb-0 text-dark fs-30">
                                {{ \App\Models\ProductSellerMap::where('seller_id', $authUser->id)->where('imported', 1)->count() }}
                            </h3>
