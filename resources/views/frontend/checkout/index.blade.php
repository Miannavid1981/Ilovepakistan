                ...
                <div class="row g-3">
                    ...
                    @if($delivery_type_settings)
                        @if($delivery_type_settings->personal)
                            <div class="col-4 m-0">
                                <div class=" py-2 w-100 delivery_type fs-16 modern-button button-personal">
                        ...
                        @if($delivery_type_settings->family_friends)
                            <div class="col-4 m-0">
                                <div class=" py-2 w-100 delivery_type fs-16 modern-button button-family">
                        ...
                        @if($delivery_type_settings->others)
                            <div class="col-4 m-0">
                                <div class=" py-2 w-100 delivery_type fs-16  modern-button button-others">
