                ...
                <div class="tab-content" style="    overflow-x: scroll !important;width: 100%;">
                    ...
                    @if(!empty($detailedProduct->pdf))
                        <div class="tab-pane" id="specifications">
                            ...
                            <a href="{{ uploaded_asset($detailedProduct->pdf) }}" class="btn btn-primary w-100px" style="margin: 0 auto; padding: 10px 20px !important;" download>Download</a>
                        </div>
                    @endif
...
function change_tab(tab, scroll) {
    ...
    if (scroll ) {
        $('html, body').animate({
            scrollTop: $(`.tab-pane[data-tab="${tab}"]`).offset().top
