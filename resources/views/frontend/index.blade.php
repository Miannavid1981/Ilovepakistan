...
#category-section .category_image:hover {
    transform: scale(1.1) translateY(-20px);
    box-shadow: 0px 1px 20px 11px #cccccc4f;
...
<div class="gallery js-flickity mt-3 mb-5"

  data-flickity-options='{ "wrapAround": true }' style="height: auto">

  <div class="gallery-cell">

      

      <img src="https://static.vecteezy.com/system/resources/previews/006/828/785/non_2x/paper-art-shopping-online-on-smartphone-and-new-buy-sale-promotion-pink-backgroud-for-banner-market-ecommerce-women-concept-free-vector.jpg" >
  ...
  <div class="gallery-cell">
      ...
      <img src="https://static.vecteezy.com/system/resources/previews/004/299/835/non_2x/online-shopping-on-phone-buy-sell-business-digital-web-banner-application-money-advertising-payment-ecommerce-illustration-search-free-vector.jpg" >
  ...
  <!--<img src="https://allaaddin.com/public/images/10150011.jpg" >-->
...
<div class="home-banner-area d-none">

    <div class="" style="margin-left: -20px; width:102.42%;">

        <div class="d-flex flex-wrap position-relative" style=" width:105.42%;">
                        ...
                        @foreach ($sliders as $key => $slider)
                            ...
                            <div class="carousel-box">
                                ...
                                <a href="{{ json_decode(get_setting('home_slider_links'), true)[$key] }}" >
                                    ...
                                    <img class="d-block mw-100 img-fit overflow-hidden" 
                    ...
                    <div class="col-xxl-4 col-lg-5 col-6 h-200px h-md-400px h-lg-475px">
                        ...
                        <div class="h-100 w-100 w-xl-auto"
                            ...
                            <div class="py-5 px-md-3 px-xl-5 d-none d-md-block">
                                ...
                                <div class="bg-white" style="height:20px !important">
                                            ...
                                            @if ($flash_deal_product->product != null && $flash_deal_product->product->published != 0)
                                                ...
                                                <div
                                                    ...
                                                    class="h-100px h-md-200px h-lg-auto flash-deal-item position-relative text-center border-bottom @if ($i != 4) border-right @endif has-transition hov-shadow-out z-1">
                                                        ...
                                                        $pro = \App\Models\ProductStock::where('product_id', $flash_deal_product->product->id)->first();
    ...
    @if (count($featured_categories) > 0)
        ...
        <section class="mb-2 mb-md-3   mt-5 mx-5" id="category-section">
            ...
            <div class="">
                ...
                <div class="bg-white">
                    ...
                    <div class="d-flex mb-2 mb-md-3 align-items-baseline justify-content-between">
                        ...
                        <h2 class="fs-25 fw-700 mb-5 mb-sm-0">
                ...
                <div class="bg-white px-sm-3">
                    ...
                    <div class="aiz-carousel sm-gutters-17" data-items="9" data-xxl-items="9" data-xl-items="8"

                        data-lg-items="7" data-md-items="4" data-sm-items="2" data-xs-items="2" data-arrows="true"
                        ...
                        @foreach ($featured_categories as $key => $category)
                            ...
                            <div
                                ...
                                class="carousel-box position-relative text-center has-transition ">
                                ...
                                <a href="{{ route('products.category', $category->slug) }}" class="d-block">
                                    ...
                                    <img src="{{ isset($category->coverImage->file_name) ? my_asset($category->coverImage->file_name) : static_asset('assets/img/placeholder.jpg') }}"
                                        ...
                                        class="lazyload  mx-auto has-transition  mw-100  rounded-circle m-4  category_image" style="aspect-ratio: 1/1; border: 1px solid #ccc; "
                                ...
                                <h6 class="text-dark my-3 h-40px text-truncate-2">
