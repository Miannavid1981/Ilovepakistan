...
<div class="container">
    <div class="privacy_policy">
        ...
        <p><strong>What personal information do we process?</strong> When you visit, use, or navigate our Services, we may process personal information depending on how you interact with us and the Services, the choices you make, and the products and features you use. <a href="#" style="color: #1a73e8;">Learn more about personal information you disclose to us.</a></p>
        
        <p><strong>Do we process any sensitive personal information?</strong> We may process sensitive personal information when necessary with your consent or as otherwise permitted by applicable law. <a href="#" style="color: #1a73e8;">Learn more about sensitive information we process.</a></p>
        
        <p><strong>Do we collect any information from third parties?</strong> We do not collect any information from third parties.</p>
        
        <p><strong>How do we process your information?</strong> We process your information to provide, improve, and administer our Services, communicate with you, for security and fraud prevention, and to comply with law. We may also process your information for other purposes with your consent. We process your information only when we have a valid legal reason to do so. <a href="#" style="color: #1a73e8;">Learn more about how we process your information.</a></p>
        
        <h3 style="font-size: 18px; font-weight: bold;">How do we process your information?</h3>
        <p>We process your information to provide, improve, and administer our Services, communicate with you, for security and fraud prevention, and to comply with law. We may also process your information for other purposes with your consent. We process your information only when we have a valid legal reason to do so. Learn more about <a href="#" style="color: #007bff; text-decoration: none;">how we process your information</a>.</p>
        
        <h2 style="color: #222;">How do we keep your information safe?</h2>
        <p>We have organizational and technical processes and procedures in place to protect your personal information. However, no electronic transmission over the internet or information storage technology can be guaranteed to be 100% secure, so we cannot promise or guarantee that hackers, cybercriminals, or other unauthorized third parties will not be able to defeat our security and improperly collect, access, steal, or modify your information. <a href="#" style="color: #1a73e8;">Learn more about how we keep your information safe.</a></p>
        
        <h2 style="color: #222;">What are your rights?</h2>
        <p>Depending on where you are located geographically, the applicable privacy law may mean you have certain rights regarding your personal information. <a href="#" style="color: #1a73e8;">Learn more about your privacy rights.</a></p>
        
        <h2 style="color: #222;">How do you exercise your rights?</h2>
        ...
        <p><strong>Want to learn more about what we do with any information we collect?</strong> <a href="#" style="color: #1a73e8;">Review the privacy notice in full.</a></p>
        <h2>TABLE OF CONTENTS</h2>
        <ol style="line-height: 1.8;">
            <li  style="cursor: pointer;"> <a href="#list1"></a>WHAT INFORMATION DO WE COLLECT?</li>
            ...
            <li  style="cursor: pointer;"> <a href=""></a>DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</li>
            <li>DO OTHER REGIONS HAVE SPECIFIC PRIVACY RIGHTS?</li>
            <li>DO WE MAKE UPDATES TO THIS NOTICE?</li>
            <li>HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</li>
            <li>HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</li>
        </ol>
        <h3 style="margin-top: 20px;" id="list1">1. WHAT INFORMATION DO WE COLLECT?</h3>
        ...
        <h3 style="margin-top: 20px;">Sensitive Information</h3>
        ...
        <h3 style="margin-top: 20px;">Social Media Login Data</h3>
        ...
        <h3 style="margin-top: 20px;">Application Data</h3>
        ...
        <ul style="line-height: 1.8;">
            ...
            <li><strong>Mobile Device Access:</strong> We may request access or permission to certain features from your mobile device, including your mobile device's contacts, social media accounts, storage, camera, microphone, reminders, SMS messages, calendar, and other features. If you wish to change our access or permissions, you may do so in your device's settings.</li>
    ...
    <h3 style="margin-top: 20px;">Information Automatically Collected</h3>
    ...
    <h4 style="margin-top: 20px;">The Information We Collect Includes:</h4>
    <ul style="line-height: 1.8;">
        <li><strong><i>Log and Usage Data:</i></strong> Log and usage data is service-related, diagnostic, usage, and performance information our servers automatically collect when you access or use our Services and which we record in log files. Depending on how you interact with us, this log data may include your IP address, device information, browser type, and settings, as well as information about your activity in the Services (such as the date/time stamps associated with your usage, pages and files viewed, searches, and other actions you take such as which features you use), device event information (such as system activity, error reports (sometimes called "crash dumps"), and hardware settings).</li>
        ...
        <li><strong><i>IP address, device type, browser type, and usage data through cookies and similar technologies:</i></strong> Data required for IT-related matters.</li>
        <li><strong><i>Log and Usage Data:</i></strong> Log and usage data is service-related, diagnostic, usage, and performance information our servers automatically collect when you access or use our Services and which we record in log files. Depending on how you interact with us, this log data may include your IP address, device information, browser type, and settings, as well as information about your activity in the Services (such as the date/time stamps associated with your usage, pages and files viewed, searches, and other actions you take such as which features you use), device event information (such as system activity, error reports (sometimes called "crash dumps"), and hardware settings).</li>
        <h2 style="font-size: 16px; color: #000;">Information Collected When You Use Our Facebook Application(s)</h2>
        ...
        <h2 style="font-size: 18px; color: #000;">Information Collected When You Use Our Facebook Application(s)</h2>
        <p style="margin: 10px 0;">
            We by default access your Facebook basic account information, including your <b>name, email, gender, birthday, current city,</b> 
            and <b>profile picture URL</b>, as well as other information that you choose to make public.
        </p>
        <p style="margin: 10px 0;">
            We may also request access to other permissions related to your account, such as <b>friends, check-ins,</b> and <b>likes</b>, and you may 
            choose to grant or deny us access to each individual permission.
        </p>
        <p style="margin: 10px 0;">
            For more information regarding Facebook permissions, refer to the <a href="https://developers.facebook.com/docs/facebook-login/permissions" 
            style="color: #0066cc; text-decoration: none;">Facebook Permissions Reference</a> page.
        </p>
        
        <h2 style="font-size: 18px; color: #000; margin-top: 20px;">2. HOW DO WE PROCESS YOUR INFORMATION?</h2>
        <p style="margin: 10px 0;"><b>In Short:</b> We process your information to provide, improve, and administer our Services, communicate with you, for security and fraud prevention, and to comply with law. We may also process your information for other purposes with your consent.</p>
        <p style="margin: 10px 0;">We process your personal information for a variety of reasons, depending on how you interact with our Services, including:</p>
        <p style="margin: 10px 0;"><b>• To facilitate account creation and authentication and otherwise manage user accounts.</b> We may process your information so you can create and log in to your account, as well as keep your account in working order.</p>
        <p style="margin: 10px 0;"><b>• To deliver and facilitate delivery of services to the user.</b> We may process your information to provide you with the requested service.</p>
        <p style="margin: 10px 0;"><b>• To respond to user inquiries/offer support to users.</b> We may process your information to respond to your inquiries and solve any potential issues you might have with the requested service.</p>
        <p style="margin: 10px 0;"><b>• To send administrative information to you.</b> We may process your information to send you details about our products and services, changes to our terms and policies, and other similar information.</p>
        <p style="margin: 10px 0;"><b>• To fulfill and manage your orders.</b> We may process your information to fulfill and manage your orders, payments, returns, and exchanges made through the Services.</p>
        <p style="margin: 10px 0;"><b>• To enable user-to-user communications.</b> We may process your information if you choose to use any of our offerings that allow for communication with another user.</p>
        <p style="margin: 10px 0;"><b>• To request feedback</b>. We may process your information when necessary to request feedback and to contact you about your use of our Services.</p>
        <p style="margin: 10px 0;"><b>• To send you marketing and promotional communications.</b> We may process the personal information you send to us for our marketing purposes, if this is in accordance with your marketing preferences. You can opt out of our marketing emails at any time. For more information, see "WHAT ARE YOUR PRIVACY RIGHTS?" below.</p>
        <p style="margin: 10px 0;"><b>• To deliver targeted advertising to you.</b> We may process your information to develop and display personalized content and advertising tailored to your interests, location, and more.</p>
        <p style="margin: 10px 0;"><b>• To protect our Services.</b> We may process your information as part of our efforts to keep our Services safe and secure, including fraud monitoring and prevention.</p>
        <p style="margin: 10px 0;"><b>• To identify usage trends.</b> We may process information about how you use our Services to better understand how they are being used so we can improve them.</p>
        <p style="margin: 10px 0;"><b>• To determine the effectiveness of our marketing and promotional campaigns.</b> We may process your information to better understand how to provide marketing and promotional campaigns that are most relevant to you.</p>
        <p style="margin: 10px 0;"><b>• To save or protect an individual's vital interest.</b> We may process your information when necessary to save or protect an individual’s vital interest, such as to prevent harm.</p>
    </ul>
    <h2 style="font-size: 18px; color: #000; margin-top: 20px;">3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR INFORMATION?</h2>
    <p style="margin: 10px 0;"><b>In Short:</b> We only process your personal information when we believe it is necessary and we have a valid legal reason (i.e., legal basis) to do so under applicable law, like with your consent, to comply with laws, to provide you with services to enter into or fulfill our contractual obligations, to protect your rights, or to fulfill our legitimate business interests.</p>

    <p style="margin: 10px 0;">If you are located in the EU or UK, this section applies to you.</p>

    <p style="margin: 10px 0;">The General Data Protection Regulation (GDPR) and UK GDPR require us to explain the valid legal bases we rely on in order to process your personal information. As such, we may rely on the following legal bases to process your personal information:</p>

    <p style="margin: 10px 0;"><b>•</b> <b>Consent.</b> We may process your information if you have given us permission (i.e., consent) to use your personal information for a specific purpose. You can withdraw your consent at any time. Learn more about withdrawing your consent.</p>

    <p style="margin: 10px 0;"><b>•</b> <b>Performance of a Contract.</b> We may process your personal information when we believe it is necessary to fulfill our contractual obligations to you, including providing our Services or at your request prior to entering into a contract with you.</p>

    <p style="margin: 10px 0;"><b>•</b> <b>Legitimate Interests.</b> We may process your information when we believe it is reasonably necessary to achieve our legitimate business interests and those interests do not outweigh your interests and fundamental rights and freedoms. For example, we may process your personal information for some of the purposes described in order to:</p>
    ...
    <p style="margin: 10px 0;"><b>•</b> <b>Legal Obligations.</b> We may process your information where we believe it is necessary for compliance with our legal obligations, such as to cooperate with a law enforcement body or regulatory agency, exercise or defend our legal rights, or disclose your information as evidence in litigation in which we are involved.</p>

    <p style="margin: 10px 0;"><b>•</b> <b>Vital Interests.</b> We may process your information where we believe it is necessary to protect your vital interests or the vital interests of a third party, such as situations involving potential threats to the safety of any person.</p>
    <h2 style="font-size: 18px; color: #000; margin-top: 20px;">4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</h2>
        <p style="margin: 10px 0;"><b>In Short:</b> We may share information in specific situations described in this section and/or with the following categories of third parties.</p>
        
        <p style="margin: 10px 0;"><b>Vendors, Consultants, and Other Third-Party Service Providers.</b> We may share your data with third-party vendors, service providers, contractors, or agents ("third parties") who perform services for us or on our behalf and require access to such information to do that work. We have contracts in place with our third parties, which are designed to help safeguard your personal information. This means that they cannot do anything with your personal information unless we have instructed them to do it. They will also not share your personal information with any organization apart from us. They also commit to protect the data they hold on our behalf and to retain it for the period we instruct.</p>
        
        <p style="margin: 10px 0;">The categories of third parties we may share personal information with are as follows:</p>
        ...
        <p><strong>When we use Google Maps Platform APIs.</strong> We may share your information with certain Google Maps Platform APIs (e.g., Google Maps API, Places API). We use certain Google Maps Platform APIs to retrieve certain information when you make location-specific requests. This includes: Location; and other similar information. A full list of what we use information for can be found in this section and in the previous section titled "HOW DO WE PROCESS YOUR INFORMATION?" We obtain and store on your device ("cache") your location. You may revoke your consent anytime by contacting us at the contact details provided at the end of this document. The Google Maps Platform APIs that we use store and access cookies and other information on your devices. If you are a user currently in the European Economic Area (EU countries, Iceland, Liechtenstein, and Norway) or the United Kingdom, please take a look at our Cookie Notice.</p>
        ...
        <h2 style="color: #000;">We also may need to share your personal information in the following situations:</h2>
        <p><strong>Business Transfers.</strong> We may share or transfer your information in connection with, or during negotiations of, any merger, sale of company assets, financing, or acquisition of all or a portion of our business to another company.</p>
        <p><strong>When we use Google Maps Platform APIs.</strong> We may share your information with certain Google Maps Platform APIs (e.g., Google Maps API, Places API). We use certain Google Maps Platform APIs to retrieve certain information when you make location-specific requests. This includes: Location; and other similar information. A full list of what we use information for can be found in this section and in the previous section titled "HOW DO WE PROCESS YOUR INFORMATION?" We obtain and store on your device ("cache") your location. You may revoke your consent anytime by contacting us at the contact details provided at the end of this document. The Google Maps Platform APIs that we use store and access cookies and other information on your devices. If you are a user currently in the European Economic Area (EU countries, Iceland, Liechtenstein, and Norway) or the United Kingdom, please take a look at our Cookie Notice.</p>
        <p><strong>Affiliates.</strong> We may share your information with our affiliates, in which case we will require those affiliates to honor this privacy notice. Affiliates include our parent company and any subsidiaries, joint venture partners, or other companies that we control or that are under common control with us.</p>
        <p><strong>Business Partners.</strong> We may share your information with our business partners to offer you certain products, services, or promotions.</p>
        ...
        <h3 style="color: #000;">5. WHAT IS OUR STANCE ON THIRD-PARTY WEBSITES?</h3>
        ...
        <h3 style="color: #000;">6. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</h3>
        ...
        <h3 style="color: #000;">7. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</h3>
        ...
        <p style="font-size: 16px;">We will only keep your personal information for as long as it is necessary for the purposes set out in this privacy notice, unless a longer retention period is required or permitted by law (such as tax, accounting, or other legal requirements). No purpose in this notice will require us keeping your personal information for longer than the period of time in which users have an account with us.</p>
        <p style="font-size: 16px;">When we have no ongoing legitimate business need to process your personal information, we will either delete or anonymize such information, or, if this is not possible (for example, because your personal information has been stored in backup archives), then we will securely store your personal information and isolate it from any further processing until deletion is possible.</p>
        <h3 style="color: #000;">9. HOW DO WE KEEP YOUR INFORMATION SAFE?</h3>
        ...
        <h3 style="color: #000;">10. DO WE COLLECT INFORMATION FROM MINORS?</h3>
            ...
            <ul style="padding-left: 20px;">
                ...
                <li>(iv) if applicable, to data portability, and</li>
                <li>(v) not to be subject to automated decision-making.</li>
            </ul>
            
            <p>In certain circumstances, you may also have the right to object to the processing of your personal information. You can make such a request by contacting us by using the contact details provided in the section <strong>"HOW CAN YOU CONTACT US ABOUT THIS NOTICE?"</strong> below.</p>
            ...
            <h4 style="font-size: 16px; font-weight: bold;">Account Information</h4>
        ...
        <p><strong>California law</strong> requires us to let you know how we respond to web browser DNT signals. Because there currently is not an industry or legal standard for recognizing or honoring DNT signals, we do not respond to them at this time.</p>
        
            <h3 style="font-size: 18px; font-weight: bold;">13. DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h3>
            ...
            <p><b>Categories of Personal Information We Collect</b></p>
            <p>We have collected the following categories of personal information in the past twelve (12) months:</p>

            <h4 style="font-size: 18px; font-weight: bold;">Data Collection Categories</h4>
            <table style="width: 100%; border-collapse: collapse; border: 1px solid #000;">
                <tr style="background-color: #f2f2f2;">
                    <th style="border: 1px solid #000; padding: 8px; text-align: left;">Category</th>
                    <th style="border: 1px solid #000; padding: 8px; text-align: left;">Examples</th>
                    <th style="border: 1px solid #000; padding: 8px; text-align: left;">Collected</th>
                </tr>
                <tr>
                    <td style="border: 1px solid #000; padding: 8px;">A. Identifiers</td>
                    <td style="border: 1px solid #000; padding: 8px;">Contact details, such as real name, alias, postal address, telephone or mobile contact number, unique personal identifier, online identifier, Internet Protocol address, email address, and account name</td>
                    <td style="border: 1px solid #000; padding: 8px;">NO</td>
                </tr>
                <tr>
                    <td style="border: 1px solid #000; padding: 8px;">B. Personal information as defined in the California Customer Records statute</td>
                    <td style="border: 1px solid #000; padding: 8px;">Name, contact information, education, employment, employment history, and financial information</td>
                    <td style="border: 1px solid #000; padding: 8px;">NO</td>
                </tr>
                <tr>
                    <td style="border: 1px solid #000; padding: 8px;">C. Protected classification characteristics under state or federal law</td>
                    <td style="border: 1px solid #000; padding: 8px;">Gender, age, date of birth, race and ethnicity, national origin, marital status, and other demographic data</td>
                    <td style="border: 1px solid #000; padding: 8px;">NO</td>
                </tr>
                <tr>
                    <td style="border: 1px solid #000; padding: 8px;">D. Commercial information</td>
                    <td style="border: 1px solid #000; padding: 8px;">Transaction information, purchase history, financial details, and payment information</td>
                    <td style="border: 1px solid #000; padding: 8px;">NO</td>
                </tr>
                <tr>
                    <td style="border: 1px solid #000; padding: 8px;">E. Biometric information</td>
                    <td style="border: 1px solid #000; padding: 8px;">Fingerprints and voiceprints</td>
                    <td style="border: 1px solid #000; padding: 8px;">NO</td>
                </tr>
                <tr>
                    <td style="border: 1px solid #000; padding: 8px;">F. Internet or other similar network activity</td>
                    <td style="border: 1px solid #000; padding: 8px;">Browsing history, search history, online behavior, interest data, and interactions with our and other websites, applications, systems, and advertisements</td>
                    <td style="border: 1px solid #000; padding: 8px;">NO</td>
                </tr>
                <tr>
                    <td style="border: 1px solid #000; padding: 8px;">G. Geolocation data</td>
                    <td style="border: 1px solid #000; padding: 8px;">Device location</td>
                    <td style="border: 1px solid #000; padding: 8px;">NO</td>
                </tr>
                <tr>
                    <td style="border: 1px solid #000; padding: 8px;">H. Audio, electronic, sensory, or similar information</td>
                    <td style="border: 1px solid #000; padding: 8px;">Images and audio, video or call recordings created in connection with our business activities</td>
                    <td style="border: 1px solid #000; padding: 8px;">NO</td>
                </tr>
                <tr>
                    <td style="border: 1px solid #000; padding: 8px;">I. Professional or employment-related information</td>
                    <td style="border: 1px solid #000; padding: 8px;">Business contact details in order to provide you our Services at a business level or job title, work history, and professional qualifications if you apply for a job with us</td>
                    <td style="border: 1px solid #000; padding: 8px;">NO</td>
                </tr>
                <tr>
                    <td style="border: 1px solid #000; padding: 8px;">J. Education Information</td>
                    <td style="border: 1px solid #000; padding: 8px;">Student records and directory information</td>
                    <td style="border: 1px solid #000; padding: 8px;">NO</td>
                </tr>
                <tr>
                    <td style="border: 1px solid #000; padding: 8px;">K. Inferences drawn from collected personal information</td>
                    <td style="border: 1px solid #000; padding: 8px;">Inferences drawn from any of the collected personal information listed above to create a profile or summary about, for example, an individual’s preferences and characteristics</td>
                    <td style="border: 1px solid #000; padding: 8px;">YES</td>
                </tr>
                <tr>
                    <td style="border: 1px solid #000; padding: 8px;">L. Sensitive personal Information</td>
                    <td style="border: 1px solid #000; padding: 8px;">Account login information, biometric data, contents of email or text messages, debit or credit card numbers, financial information including account access details, genetic data, national origin, precise geolocation, racial or ethnic origin and state id card numbers</td>
                    <td style="border: 1px solid #000; padding: 8px;">YES</td>
                </tr>
            </table>

            <p style="font-size: 16px; color: black;">We only collect sensitive personal information, as defined by applicable privacy laws or the purposes allowed by law or with your consent. Sensitive personal information may be used, or disclosed to a service provider or contractor, for additional, specified purposes. You may have the right to limit the use or disclosure of your sensitive personal information. We do not collect or process sensitive personal information for the purpose of inferring characteristics about you.</p>

            <p style="font-size: 16px; color: black;">We may also collect other personal information outside of these categories through instances where you interact with us in person, online, or by phone or mail in the context of:</p>
            ...
            <p style="font-size: 16px; color: black;">We will use and retain the collected personal information as needed to provide the Services or for:</p>
            
            <ul style="font-size: 16px; color: black;">
            <li>Category H - As long as required by the applicable laws</li>
            <li>Category K - As long as required by the applicable laws</li>
            <li>Category L - As long as the user has an account with us</li>
            </ul>
            
            <p style="font-size: 16px; color: black;"><b>Sources of Personal Information</b></p>
            
            <p style="font-size: 16px; color: black;">Learn more about the sources of personal information we collect in "WHAT INFORMATION DO WE COLLECT?"</p>

            <p style="font-size: 16px; color: black;"><b>How We Use and Share Personal Information</b></p>

            <p style="font-size: 16px; color: black;">Learn about how we use your personal information in the section, "HOW DO WE PROCESS YOUR INFORMATION?"</p>
            
            <p style="font-size: 16px; color: black;">We collect and share your personal information through:</p>
            ...
            <h3 style="font-weight: bold;">Will your information be shared with anyone else?</h3>
        ...
        <h3 style="font-weight: bold;">Your Rights</h3>
    ...
    <p style="color: #000;">Under certain US state data protection laws, you can designate an authorized agent to make a request on your behalf. We may deny a request from an authorized agent that does not submit proof that they have been validly authorized to act on your behalf in accordance with applicable laws.</p>

    <h4 style="color: #000;">Request Verification</h4>

    <p style="color: #000;">Upon receiving your request, we will need to verify your identity to determine you are the same person about whom we have the information in our system. We will only use personal information provided in your request to verify your identity or authority to make the request. However, if we cannot verify your identity from the information already maintained by us, we may request that you provide additional information for the purposes of verifying your identity and for security or fraud-prevention purposes.</p>

    <p style="color: #000;">If you submit the request through an authorized agent, we may need to collect additional information to verify your identity before processing your request and the agent will need to provide a written and signed permission from you to submit such request on your behalf.</p>
    ...
    <p style="color: #000;">California Civil Code Section 1798.83, also known as the "Shine The Light" law, permits our users who are California residents to request and obtain from us, once a year and free of charge, information about categories of personal information (if any) we disclosed to third parties for direct marketing purposes and the names and addresses of all third parties with which we shared personal information in the immediately preceding calendar year. If you are a California resident and would like to make such a request, please submit your request in writing to us by using the contact details provided in the section <strong>"HOW CAN YOU CONTACT US ABOUT THIS NOTICE?"</strong></p>

    <h3>14. DO OTHER REGIONS HAVE SPECIFIC PRIVACY RIGHTS?</h3>
