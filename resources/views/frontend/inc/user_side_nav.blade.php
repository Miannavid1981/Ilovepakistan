            ...
            <ul class="aiz-side-nav-list mb-3 pb-3 border-bottom" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('customerorders.index') }}"
                        class="aiz-side-nav-link {{ areActiveRoutes(['customerorders.index', 'customerorders.details']) }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                        ...
                        <span class="aiz-side-nav-text ml-3">{{ translate('Orders') }}</span>
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('customer_addresses.index') }}"
                        ...
                        <svg fill="#b5b5bf" width="16" height="16" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span class="aiz-side-nav-text ml-3">{{ translate('My Addresses') }}</span>
                    </a>
                </li>
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('customer.deposit-requests') }}"
                        ...
                        <span class="aiz-side-nav-text ml-3">{{ translate('Deposit Requests') }}</span>
                    </a>
                </li>
