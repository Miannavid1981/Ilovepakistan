                    ...
                    <div class="col">
                        <div class="p-4 bg-primary @if (!addon_is_activated('club_point')) h-100 @endif"
                            ...
                            <div class="d-flex align-items-center pb-4 ">
                                ...
                                <div
                                    style="width: 48px; height: 48px; border-radius: 24px; background: rgba(255, 255, 255, 0.5); display: flex; align-items: center; justify-content: center;">
                                    <!-- PNG image -->
                                    <img src="https://allaaddin.com/public/assets/img/icon_cur.png" alt="Icon"
            ...
            <div class="col-xl-6 col-md-6 mb-6">
                <div class="h-100"
                    ...
                    <div class="p-4 h-100 w-100 w-xl-50">
                        <p class="fs-14 fw-400 text-gray mb-3">{{ translate('Allaaddin Wallet Balance') }}</p>
    ...
    <div class="row gutters-16 mt-2">
        ...
        <div class="col-xl-4 col-md-6 mb-4">
            <div class="px-4 bg-white border h-100">
                ...
                <div class="d-flex align-items-center py-4 border-bottom" onclick="location.href='{{ route('cart') }}'"
