<form class="form-default" role="form" action="{{ route('addresses.update', $address_data->id) }}" method="POST">
    ...
    <div class="p-3">
        @php
            $nameParts = explode(' ', $address_data->name, 2);
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control mb-3 rounded-0" placeholder="{{ translate('Your Name')}}" value="{{ $firstName }}" name="name" required>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control mb-3 rounded-0" placeholder="{{ translate('Last Name')}}" value="{{ $lastName }}" name="last_name" required>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control mb-3 rounded-0" placeholder="{{ translate('Famous Land Mark')}}" value="{{ $address_data->land_mark }}" name="land_mark" required>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control mb-3 rounded-0" placeholder="{{ translate('+')}}" value="{{ $address_data->phone }}" name="phone" value="" required>
            </div>
        </div>
