...
@section('content')
            ...
            <div class="row">
                <div class="col-xxl-8 col-xl-10 mx-auto">
                    <div class="border bg-white p-4 mb-4">
                        <form class="form-default" action="{{ route('finalize_order_checkout') }}" role="form"
                            method="POST">
                            @csrf
                            @php
                                $admin_products = [];
    ...
    -->
                                        ...
                                        <!--                            name="shipping_type"-->
                                        <!--                            value="home_delivery"-->
                                        <!--                            onchange="updateShipmentType(this)"-->
                                        <!--                            data-target=".pickup_point_id_admin"-->
                                        <!--                            checked-->
                                        <!--                        >-->
                                        <!--                        <span class="d-flex aiz-megabox-elem rounded-0 custom-padding">-->
                                        ...
                                        <!--                        <span class="d-flex aiz-megabox-elem rounded-0 custom-padding">-->
                                        <!--                            <span class="aiz-rounded-check flex-shrink-0 mt-1"></span>-->
                                        <!--                            <span class="flex-grow-1 pl-3 fw-600">Office</span>-->
                                        <!--                        </span>-->
                                        <!--                    </label>-->
                                        <!--                </div>-->
                                        ...
                                        <!--                        <span class="d-flex aiz-megabox-elem rounded-0 custom-padding">-->
                                        <!--                            <span class="aiz-rounded-check flex-shrink-0 mt-1"></span>-->
                                        <!--                            <span class="flex-grow-1 pl-3 fw-600">Friends & Family</span>-->
                                        <!--                        </span>-->
                                        <!--                    </label>-->
                                        <!--                </div>-->
                                        <!-- Carrier -->
        ...
        <div class="col-6">
            <label class="aiz-megabox d-block bg-white mb-0">
                <input type="radio" name="shipping_type_{{ $product->id }}" value="home_delivery"
                    onchange="show_pickup_point(this, 'admin')" data-target=".pickup_point_id_admin" checked>
                <span class="d-flex aiz-megabox-elem rounded-0" style="padding: 0.75rem 1.2rem;">
                    <span class="aiz-rounded-check flex-shrink-0 mt-1"></span>
                    <span class="flex-grow-1 pl-3 fw-600">{{ translate('My Home') }}</span>
                </span>
            </label>
        </div>
        <div class="col-6">
            <label class="aiz-megabox d-block bg-white mb-0">
                <input type="radio" name="shipping_type_{{ $product->id }}" value="office"
                    onchange="show_pickup_point(this, 'admin')" data-target=".pickup_point_id_admin">
                <span class="d-flex aiz-megabox-elem rounded-0" style="padding: 0.75rem 1.2rem;">
                    <span class="aiz-rounded-check flex-shrink-0 mt-1"></span>
                    <span class="flex-grow-1 pl-3 fw-600">{{ translate('My Office') }}</span>
                </span>
            </label>
        </div>
        <div class="col-6">
            <label class="aiz-megabox d-block bg-white mb-0">
                <input type="radio" name="shipping_type_{{ $product->id }}" value="friends_family"
                    onchange="show_pickup_point(this, 'admin')" data-target=".pickup_point_id_admin">
                <span class="d-flex aiz-megabox-elem rounded-0" style="padding: 0.75rem 1.2rem;">
                    <span class="aiz-rounded-check flex-shrink-0 mt-1"></span>
                    <span class="flex-grow-1 pl-3 fw-600">{{ translate('Family & Friends') }}</span>
                </span>
            </label>
        </div>
        <div class="col-6">
            <label class="aiz-megabox d-block bg-white mb-0">
                <input type="radio" name="shipping_type_{{ $product->id }}" value="others"
                    onchange="show_pickup_point(this, 'admin')" data-target=".pickup_point_id_admin">
                <span class="d-flex aiz-megabox-elem rounded-0" style="padding: 0.75rem 1.2rem;">
                    <span class="aiz-rounded-check flex-shrink-0 mt-1"></span>
                    <span class="flex-grow-1 pl-3 fw-600">{{ translate('Other') }}</span>
                </span>
            </label>
        </div>
...
@section('script')
    ...
    <script>
        function updateShipmentType(radio) {
            // Get the text of the selected shipment type
            const selectedValue = radio.nextElementSibling.querySelector('.fw-600').innerText;
            // Save the selected value in local storage
            localStorage.setItem('shipmentType', selectedValue);
        }
    </script>
@endsection
