            ...
            <div class="d-block h-100 position-relative">
                ...
                <img class="lazyload mx-auto img-fit has-transition " style="aspect-ratio: 1.5 /1.8; border: 1px solid #dbdbdb; border-radius: 15px; !important;"
                    ...
                    <span> Quick View</span>
                        ...
                        <button class="add-to-cart w-100 d-block g-add-to-cart" data-id="{{ $product->id }}" data-skin_code="{{ $product->product_skin ?? get_product_seller_map_skin($product) }}" ><i class="las la-shopping-cart fs-24 me-2"></i> <span>Add to cart</span> </button>
