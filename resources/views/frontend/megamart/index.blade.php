            ...
            @endphp
                @foreach ($categories as $category )
                        ...
                        <a href="{{ route('products.category', $category->slug) }}" class="d-flex flex-column align-items-center justify-content-center rounded-circle border-1 border home_category">
                            <img src="{{uploaded_asset($category->icon)}}" class="" style="width: 50px; height: auto; aspect-ratio: 1 / 1;" >
                            <p class="mt-2 text-dark fs-12 text-center mb-0">   {{$category->name}}</p>
                        </a>
...
<div class="services-icons mb-5 " style="background: #eee;">
    <div class="container py-4"> 
        <div class="row text-center d-flex align-items-end">
            ...
            <div class="services-promises col-lg-3 col-md-6 col-sm-12 mb-3">
                <div class="row">
                    <div class="col-md-2  d-flex align-items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" fill="currentColor" class="bi bi-telephone-outbound" viewBox="0 0 16 16">
           ...
           <div class="services-promises col-lg-3 col-md-6 col-sm-12 mb-3">
            ...
            <div class="services-promises col-lg-3 col-md-6 col-sm-12 mb-3">
                <div class="row">
                    <div class="col-md-2 d-flex align-items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" fill="currentColor" class="bi bi-patch-check" viewBox="0 0 16 16">
