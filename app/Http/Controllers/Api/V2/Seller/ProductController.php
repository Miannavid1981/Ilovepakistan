...
class ProductController extends Controller
{
    ...
    public function categoryPreferences(Request $request)
    {
        $preferences = \App\Models\SellerCategoryPreference::where('user_id',  auth()->user()->id)
                      ->get();
    ...
    public function updateCategoryPreferences(Request $request)
    {
        ...
        return $this->success(translate('Category preferences updated successfully.'));
