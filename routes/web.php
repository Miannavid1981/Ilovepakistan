...
Route::get('/test-email', function () {
    $combined_order = App\Models\CombinedOrder::findOrFail(833);
    $orders=$combined_order->orders;
    return view('emails.invoice', compact('orders'));
});
...
Route::controller(CartController::class)->group(function () {
    ...
    // Route::delete('/cart/delete','deleteItem')->name('cart.delete');
    // Route::post('/cart/update-quantity', 'updateQuantity')->name('cart.update.quantity');
    Route::post('/cart/update-quantity','updateQty')->name('cart.update.quantity');
    Route::delete('/cart/delete', 'deleteItem')->name('cart.delete');
...
Route::group(['middleware' => ['customer', 'verified', 'unbanned']], function () {
    ...
    Route::controller(PurchaseHistoryController::class)->group(function () {
        Route::get('/purchase_history/details/{order_id}/{id?}', 'purchase_history_details')->name('purchase_history.details');
        ...
        Route::post('/payment_info', 'payment_info')->name('payment_info');
...
//Blog Section
Route::post('/currency-converter', [BlogController::class, 'currency_converter'])->name('currency-converter');
